...
both are used as buzz-words. The formulation of the posterior is by including logic of formulating the prior based on past evidence 
...
in a form of pseudo-webiste on github.
